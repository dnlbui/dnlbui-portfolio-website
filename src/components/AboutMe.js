  ...
  return (
    ...
    >
      ...
      <div className="col-md-8" id="about-desc">
        ...
        <p>
          With my new interest in finance, I joined Fidelity. I gained valuable
          interpersonal skills at Fidelity. I assisted customers with
          withdrawing 401k's, taking out loans, and quickly triaged urgent
          problems the customers presented. With this experience and confidence
          gained. I felt the push to pursue my passion in technology, where I've
          always been weary about until I started networking and gained
        ...
        <p>
          ...
          attend local developer meet-ups in Dallas. My goal is to get a professional
          job in tech and provide value to an organization that provides me with
          the opportunity.
        </p>
        <div className="arrow">
